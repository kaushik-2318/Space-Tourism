...
function Crew() {
  ...
  return (
    <>
      <div className="crew bg-no-repeat bg-cover bg-center h-full w-full pb-10 md:pb-0 lg:h-screen">
        <div className='flex justify-center items-center flex-col w-full'>
          ...
          <div className='flex justify-center items-start lg:items-center flex-col md:flex-col-reverse lg:flex-row-reverse lg:gap-10 lg:w-full'>
            <div className='w-[327px] h-[223px] md:w-full md:h-[300px] lg:h-[400px] flex justify-center items-center lg:w-1/2'>
              <img className='border-b-3 border-[#ffffff40] w-[177.12px] md:w-[250px] md:h-[300px] h-[222px] lg:w-[400px] lg:h-[400px]' src={crewMember.images} alt="" />
            </div>
